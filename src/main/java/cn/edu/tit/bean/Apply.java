...
public class Apply {
	...
	public String toString() {
		return "Apply [applyId=" + applyId + ", applyUserName=" + applyUserName + ", nation=" + nation
				+ ", politicsStatus=" + politicsStatus + ", nativePlace=" + nativePlace + ", identityNum=" + identityNum
				+ ", isMarry=" + isMarry + ", speciality=" + speciality + ", telephone=" + telephone
				...
				+ ", workExperience=" + workExperience + ", occupationApplicant=" + occupationApplicant + "]";
	}
	public Apply(String applyId, String applyUserName, String nation, String politicsStatus, String nativePlace,
			String identityNum, String isMarry, String speciality, String telephone, String bachelorDegreeAndMajor,
			String undergraduateGraduationTime, String graduateSchoolAndMajor, String graduateTime,
			String doctoralDegreeAndMajor, String doctoralGraduationTime, String workOrganization, String position,
			String telephoneOriganization, String professionalAndTechnicalQualification, String practicingRequirements,
			String mailingAddress, String postalAddress, String eMail, String applicationOrganization,
			String majorApplicant, String workExperience, String occupationApplicant) {
		super();
		this.applyId = applyId;
		this.applyUserName = applyUserName;
		this.nation = nation;
